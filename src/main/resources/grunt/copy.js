    ...
    libs:{
        files:[
            ...
            },
            {
                ...
                dest: 'websrc/libs/assets',
                cwd:  'bower_components',
                expand: true
            },
            {src: '**', cwd: 'bower_components/bootstrap/dist/fonts', dest: 'websrc/fonts', expand: true}
        ]
    },
    webapp: {
        files: [
            {expand: true, src: "**", cwd: 'websrc/fonts',   dest: "webapp/fonts"},
            {expand: true, src: "**", cwd: 'websrc/api',     dest: "webapp/api"},
            {expand: true, src: "**", cwd: 'websrc/l10n',    dest: "webapp/l10n"},
            {expand: true, src: "**", cwd: 'websrc/img',     dest: "webapp/img"},
            {expand: true, src: "**", cwd: 'websrc/js',      dest: "webapp/js"},
            {expand: true, src: "**", cwd: 'websrc/tpl',     dest: "webapp/tpl"},
            {src: 'websrc/index.min.html', dest : 'webapp/index.html'},
            {src: 'websrc/material.min.html', dest : 'webapp/material.html'}
        ]
    },
    html: {
        files: [
            {expand: true, src: '**', cwd:'websrc/fonts/', dest: 'html/fonts/'},
            {expand: true, src: "**", cwd: 'websrc/api',     dest: "html/api"},
            {expand: true, src: '**', cwd:'websrc/img/', dest: 'html/img/'},
            {expand: true, src: '*.css', cwd:'websrc/css/', dest: 'html/css/'},
            {expand: true, src: '**', cwd:'swig/js/', dest: 'html/js/'}
        ]
    },
    landing: {
        files: [
            {expand: true, src:'**', cwd:'websrc/fonts/', dest: 'landing/fonts/'},
            {expand: true, src:'*.css', cwd:'websrc/css/', dest: 'landing/css/'},
